Namespace CustomizeOfficeNavigationBar.Win
    Partial Public Class OfficeNavigationBarCustomizationWindowsFormsModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' OfficeNavigationBarCustomizationWindowsFormsModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(CustomizeOfficeNavigationBar.OfficeNavigationBarCustomizationModule))
